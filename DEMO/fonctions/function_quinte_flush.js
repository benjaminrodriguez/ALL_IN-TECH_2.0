...
var function_quinte_flush = function (carte1Joueur, carte2Joueur, riviere, joueur, partie) {
	...
	if(testQuinteFlush === quinteFlush){
		for(i = 0; i < quinteFlush.length; i++){
			if(Number(carte1Joueur) === Number(quinteFlush[i]) || Number(carte2Joueur) === Number(quinteFlush[i])){
